...
def kurucz_marcs(logg='LOGG_SYD_SCALING',apokasc='APOKASC_cat_v3.6.0.fits') :
    ...
    # color code by [M/H]
    #plots.plotc(ax1,l30i['FPARAM'][i1,0],l30i['FPARAM'][i1,1]-apokasc[logg][i2],l30i['FPARAM'][i1,3],zr=[-1,0.5],xr=[3500,5000],yr=[-1,1],xt='Teff',yt='ASPCAP-seismic log g',label=[3600,0.7,'l30i (MARCS)'],colorbar=True,zt='[M/H]')
    # color code by [alpha/M]
    plots.plotc(ax1,l30i['FPARAM'][i1,0],l30i['FPARAM'][i1,1]-apokasc[logg][i2],l30i['FPARAM'][i1,6],zr=[-0.1,0.4],xr=[3500,5000],yr=[-1,1],xt='seismic log g',yt='ASPCAP-seismic log g',label=[3600,0.7,'l30i (MARCS)'],colorbar=True,zt='[alpha/M]')
    ...
    # colod code by Teff
    #plots.plotc(ax2,l30i['FPARAM'][i1,1],l30i['FPARAM'][i1,1]-apokasc[logg][i2],l30i['FPARAM'][i1,0],zr=[3500,5000],xr=[0,5],yr=[-1,1],xt='seismic log g',yt='ASPCAP-seismic log g',label=[4,0.7,'l30i'],colorbar=True,zt='Teff')
    ...
    #plt.xlim(1.60,1.15)
    #plt.ylim(1.15,1.85)
    #plots.plotc(ax2,dr13['FPARAM'][i1,0],dr13['FPARAM'][i1,1]-apokasc[logg][i2],dr13['FPARAM'][i1,3],zr=[-1,0.5],xr=[3500,5000],yr=[-1,1],xt='Teff',yt='ASPCAP-seismic log g',label=[3600,0.7,'dr13 (Kurucz)'],colorbar=True,zt='[M/H]')
    plots.plotc(ax2,dr13['FPARAM'][i1,0],dr13['FPARAM'][i1,1]-apokasc[logg][i2],dr13['FPARAM'][i1,6],zr=[-0.1,0.4],xr=[3500,5000],yr=[-1,1],xt='seismic log g',yt='ASPCAP-seismic log g',label=[3600,0.7,'dr13 (Kurucz)'],colorbar=True,zt='[alpha/M]')
    ##plots.plotc(ax4,dr13['FPARAM'][i1,1],dr13['FPARAM'][i1,1]-apokasc[logg][i2],dr13['FPARAM'][i1,0],zr=[3500,5000],xr=[0,5],yr=[-1,1],xt='seismic log g',yt='ASPCAP-seismic log g',label=[4,0.7,'dr13'],colorbar=True,zt='Teff')
...
def dr13(logg='LOGG_SYD_SCALING',apokasc='APOKASC_cat_v3.6.0.fits') :
    ...
    plots.plotc(ax[0,0],dr13['FPARAM'][i1,3],dr13['FPARAM'][i1,1]-apokasc[logg][i2],dr13['FPARAM'][i1,1],zr=[0,5],xr=[-2.5,0.5],yr=[-1,1],xt='[M/H]',yt='ASPCAP-seismic log g')
    plots.plotc(ax[0,1],dr13['PARAM'][i1,3],dr13['PARAM'][i1,1]-apokasc[logg][i2],dr13['PARAM'][i1,1],zr=[0,5],xr=[-2.5,0.5],yr=[-1,1],xt='[M/H]',colorbar=True,zt='log g')

    # diff color-coded by [M/H] as f(log g)
    plots.plotc(ax[1,0],dr13['FPARAM'][i1,1],dr13['FPARAM'][i1,1]-apokasc[logg][i2],dr13['FPARAM'][i1,3],xr=[0,5],zr=[-2.5,0.5],yr=[-1,1],zt='[M/H]',yt='ASPCAP-seismic log g',xt='log g')
    plots.plotc(ax[1,1],dr13['PARAM'][i1,1],dr13['PARAM'][i1,1]-apokasc[logg][i2],dr13['PARAM'][i1,3],xr=[0,5],zr=[-2.5,0.5],yr=[-1,1],zt='[M/H]',colorbar=True,xt='log g')

    # RGB and RC a f(log g)
    plots.plotp(ax[2,0],dr13['FPARAM'][i1[rgb],1],dr13['FPARAM'][i1[rgb],1]-apokasc[logg][i2[rgb]],xr=[0,5],yr=[-1,1],xt='seismic log g',yt='ASPCAP-seismic log g',label=[3600,0.7,'dr13 (Kurucz)'],color='r')
    plots.plotp(ax[2,0],dr13['FPARAM'][i1[rc],1],dr13['FPARAM'][i1[rc],1]-apokasc[logg][i2[rc]],xr=[0,5],yr=[-1,1],xt='seismic log g',yt='ASPCAP-seismic log g',label=[3600,0.7,'dr13 (Kurucz)'],color='b')
    plots.plotp(ax[2,1],dr13['PARAM'][i1[rgb],1],dr13['PARAM'][i1[rgb],1]-apokasc[logg][i2[rgb]],xr=[0,5],yr=[-1,1],xt='log g',label=[3600,0.7,'dr13 (Kurucz)'],color='r')
    plots.plotp(ax[2,1],dr13['PARAM'][i1[rc],1],dr13['PARAM'][i1[rc],1]-apokasc[logg][i2[rc]],xr=[0,5],yr=[-1,1],xt='log g',label=[3600,0.7,'dr13 (Kurucz)'],color='b')
...
def dr13dr12() :
    ...
    plots.plotc(ax[1,0],dr13['PARAM'][i1,3],dr13['PARAM'][i1,1]-apokasc['LOGG_SYD_SCALING'][i2],dr13['PARAM'][i1,0],xr=[-2.5,1.],yr=[-2,2],zr=[3500,5500],xt='[M/H]',yt='ASPCAP-seismic log g',label=[-2.,1.5,'DR13 cal'])
