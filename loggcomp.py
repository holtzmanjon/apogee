...
def rcrgb(allstar,apokasc='APOKASC_cat_v3.6.0.fits',rclim=np.array([2.38,3.5]),out='rcrgbsep') :
    '''
...
def apokasc(allstar,logg='LOGG_SYD_SCALING',apokasc='APOKASC_cat_v3.6.0.fits',raw=True,plotcal=False,out='loggcomp',calloggrange=[-1.,3.8],loggrange=[1.,3.2],mhrange=[-2.5,0.5],teffrange=[3500,5500],calib=False) :
    '''
    asteroseismic log g comparisons for input allStar structure
    '''
    ...
    errpar = cal.errfit(allstar[param][i1[rgb],0],allstar['SNR'][i1[rgb]],allstar[param][i1[rgb],3],
    ...
    errpar = cal.errfit(allstar[param][i1[rc],0],allstar['SNR'][i1[rc]],allstar[param][i1[rc],3],
    ...
    if raw :
        ...
        plots.plotc(tmpax[0],allstar['FPARAM'][i1,3],allstar[param][i1,1]-apokasc[logg][i2],
           allstar['FPARAM'][i1,1],zr=[0,5],xr=[-2.5,0.5],yr=[-1,1],xt='[M/H]',yt='ASPCAP-seismic log g',size=15)
        plots.plotc(tmpax[1],allstar['FPARAM'][i1,1],allstar[param][i1,1]-apokasc[logg][i2],
           allstar['FPARAM'][i1,3],xr=[0,5],zr=[-2.5,0.5],yr=[-1,1],zt='[M/H]',yt='ASPCAP-seismic log g',xt='log g',size=15)
    ...
    if plotcal :
        ...
        plots.plotc(tmpax[1],allstar['FPARAM'][i1,1],param[i1]-apokasc[logg][i2],
           allstar['FPARAM'][i1,3],xr=[0,5],zr=[-2.5,0.5],yr=[-1,1],zt='[M/H]',colorbar=True,xt='log g',size=15)
        plots.plotp(tmpax[2],allstar['FPARAM'][i1[rgb],1],param[i1[rgb]]-apokasc[logg][i2[rgb]],
           xr=[0,5],yr=[-1,1],xt='log g',color='r',size=15)
        plots.plotp(tmpax[2],allstar['FPARAM'][i1[rc],1],param[i1[rc]]-apokasc[logg][i2[rc]],
           xr=[0,5],yr=[-1,1],xt='log g',color='b',size=15)
    ...
    return {'calloggmin' : calloggrange[0], 'calloggmax' : calloggrange[1], 'loggmin' : loggrange[0], 'loggmax' : loggrange[1], 
            ...
            'rgbfit' : rgbfit.parameters, 'rcfit' : rcfit.parameters, 'rgbrms' : rgbrms, 'rcrms' : rcrms }
